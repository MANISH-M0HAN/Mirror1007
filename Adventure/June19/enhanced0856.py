...
class Chatbot:
    ...
    def correct_spelling(self, text):
        ...
        for word in text.split():
            ...
            # Only correct if the corrected word is not None and is different from the original word
    ...
    def find_best_context(self, query, threshold=0.3):  # Lowered threshold
    ...
    def get_response(self, user_input, threshold=0.3):  # Lowered threshold

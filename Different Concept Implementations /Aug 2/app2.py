'''
Probably better than the app.py of Aug 2
Fixes:
1. Session works
2. Less logs
3. Able to differentiate I am PMS from What is PMS
4. Check for other case such as w, k or I am women,Women, Cheessssttt ppppainnn.
'''
import os
import pandas as pd
import logging
